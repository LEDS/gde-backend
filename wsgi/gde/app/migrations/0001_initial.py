...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', auto_created=True, primary_key=True, serialize=False)),
                ('nome', models.CharField(unique=True, null=True, max_length=30)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', auto_created=True, primary_key=True, serialize=False)),
                ('nome', models.CharField(unique=True, null=True, max_length=60)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', auto_created=True, primary_key=True, serialize=False)),
                ('nome', models.CharField(unique=True, null=True, max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Fase',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', auto_created=True, primary_key=True, serialize=False)),
                ('descricao', models.CharField(unique=True, null=True, max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Setor',
            fields=[
                ...
                ('campus', models.ForeignKey(to='app.Campus', null=True, verbose_name='Campus')),
            ],
        ),
        migrations.CreateModel(
            name='Suporte',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('historico', models.CharField(null=True, blank=True, max_length=50)),
                ('identificacao', models.CharField(unique=True, max_length=50)),
                ...
                ('dataEnvio', models.DateField(null=True, auto_now=True)),
                ('atividade', models.ForeignKey(related_name='atividade', to='app.Atividade')),
                ('elemento', models.ManyToManyField(to='app.Elemento', related_name='elemento')),
                ('especieDocumental', models.ForeignKey(related_name='especieDocumental', to='app.EspecieDocumental')),
                ('fases', models.ForeignKey(related_name='fases', to='app.Fase')),
                ...
                ('setor', models.ForeignKey(related_name='setor', to='app.Setor')),
                ('suporte', models.ForeignKey(related_name='suporte', to='app.Suporte')),
                ('tipoAcumulo', models.ForeignKey(to='app.TipoAcumulo', related_name='tipoAcumulo', null=True, blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ('id', models.AutoField(verbose_name='ID', auto_created=True, primary_key=True, serialize=False)),
                ('setor', models.ForeignKey(to='app.Setor', null=True, verbose_name='Setor')),
        ...
        migrations.AddField(
            ...
            name='usuario',
            field=models.ForeignKey(related_name='usuario', to='app.Usuario'),
        ),
        migrations.AddField(
            model_name='resposta',
            name='tipologia',
            field=models.OneToOneField(to='app.Tipologia'),
        ),
        migrations.AddField(
            model_name='conarq',
            name='codGrupo',
        ...
        migrations.AddField(
            model_name='classificaarquivosifes',
            name='grupo',
            field=models.ForeignKey(related_name='grupo', to='app.GrupoConarq'),
        ),
        migrations.AddField(
