    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacoes', models.TextField(null=True)),
                ('codigo', models.ForeignKey(to='app.Conarq', related_name='codigo')),
                ('grupo', models.ForeignKey(to='app.GrupoConarq', related_name='grupo')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atividade', models.ForeignKey(to='app.Atividade', related_name='atividade')),
                ('elemento', models.ManyToManyField(to='app.Elemento', related_name='elemento')),
                ('especieDocumental', models.ForeignKey(to='app.EspecieDocumental', related_name='especieDocumental')),
                ('fases', models.ForeignKey(to='app.Fase', related_name='fases')),
                ...
                ('setor', models.ForeignKey(to='app.Setor', related_name='setor')),
                ('suporte', models.ForeignKey(to='app.Suporte', related_name='suporte')),
                ('tipoAcumulo', models.ForeignKey(to='app.TipoAcumulo', null=True, blank=True, related_name='tipoAcumulo')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
        ...
        migrations.AddField(
            ...
            name='usuario',
            field=models.ForeignKey(to='app.Usuario', related_name='usuario'),
        ),
        migrations.AddField(
            model_name='conarq',
            name='codGrupo',
            field=models.ForeignKey(to='app.GrupoConarq', related_name='codGrupo'),
        ),
        migrations.AddField(
